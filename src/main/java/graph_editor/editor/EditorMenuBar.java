...
import graph_editor.editor.EditorActions.AlignCellsAction;
import graph_editor.editor.EditorActions.AutosizeAction;
import graph_editor.editor.EditorActions.BackgroundAction;
import graph_editor.editor.EditorActions.BackgroundImageAction;
import graph_editor.editor.EditorActions.ColorAction;
import graph_editor.editor.EditorActions.ExitAction;
import graph_editor.editor.EditorActions.GridColorAction;
import graph_editor.editor.EditorActions.GridStyleAction;
import graph_editor.editor.EditorActions.HistoryAction;
import graph_editor.editor.EditorActions.ImportAction;
import graph_editor.editor.EditorActions.KeyValueAction;
import graph_editor.editor.EditorActions.NewAction;
import graph_editor.editor.EditorActions.OpenAction;
import graph_editor.editor.EditorActions.PageBackgroundAction;
import graph_editor.editor.EditorActions.PageSetupAction;
import graph_editor.editor.EditorActions.PrintAction;
import graph_editor.editor.EditorActions.PromptPropertyAction;
import graph_editor.editor.EditorActions.PromptValueAction;
import graph_editor.editor.EditorActions.SaveAction;
import graph_editor.editor.EditorActions.ScaleAction;
import graph_editor.editor.EditorActions.SelectShortestPathAction;
import graph_editor.editor.EditorActions.SelectSpanningTreeAction;
import graph_editor.editor.EditorActions.SetLabelPositionAction;
import graph_editor.editor.EditorActions.SetStyleAction;
import graph_editor.editor.EditorActions.StyleAction;
import graph_editor.editor.EditorActions.StylesheetAction;
import graph_editor.editor.EditorActions.ToggleAction;
import graph_editor.editor.EditorActions.ToggleConnectModeAction;
import graph_editor.editor.EditorActions.ToggleCreateTargetItem;
import graph_editor.editor.EditorActions.ToggleDirtyAction;
import graph_editor.editor.EditorActions.ToggleGridItem;
import graph_editor.editor.EditorActions.ToggleOutlineItem;
import graph_editor.editor.EditorActions.TogglePropertyItem;
import graph_editor.editor.EditorActions.ToggleRulersItem;
import graph_editor.editor.EditorActions.WarningAction;
import graph_editor.editor.EditorActions.ZoomPolicyAction;
...
public class EditorMenuBar extends JMenuBar
{
	...
	public EditorMenuBar(final BasicGraphEditor editor)
	{
		...
		submenu.add(editor.bind(mxResources.get("basicStyle"),
				new StylesheetAction("basic-style.xml")));
